...
import (
	...
	"github.com/irononet/coffeeco/internal/loyalty" 
...
func (s Service) CompletePurchase(ctx context.Context, storeID uuid.UUID, purchase *Purchase, coffeeBuxCard *loyalty.CoffeeBux) error{
	...
	if err := s.calculateSpecificDiscount(ctx, storeID, purchase); err != nil{
		return err 
	}
...
func (s *Service) calculateSpecificDiscount(ctx context.Context, storeID uuid.UUID, purchase *Purchase) error{
